...
//                AssignGuildMembersToRole(message, new List<string> { cmd }, false);
//            }
...
////                await message.RespondAsync($"Starting default city feed assignment for all users of guild **{guild.Name}**.");
...
////                            Console.WriteLine($"Assigned {member.Username} to city feed role {cityRole.Name}.");
////                        }
////                        success++;
////                    }
////                    catch (Exception ex)
...
////                Console.WriteLine("Finished assigning all default city feed roles.");

////                await message.RespondAsync
////                (
////                    $"{success}/{guild.MemberCount} members were assigned the default city feed roles and {errors} members' roles were not set." +
////                    (failed.Count == 0 ? "" : "\r\nList of users whose city feed roles failed:\r\n" + string.Join(Environment.NewLine, failed))
////                );
////            })
